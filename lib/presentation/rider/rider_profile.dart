...
class _RiderProfileState extends State<RiderProfile> {
  ...
  final users = FirebaseFirestore.instance.collection('riders');
  SellerModel? user;
  Future<String> updateRiderProfile() async {
    String RiderProfileUrl =
        await _FirebaseUserRepository.uploadProfileImage(
            imageFile: _RiderProfileImage!, uid: utils.currentUserUid);
    return RiderProfileUrl;
  }
  ...
  Widget build(BuildContext context) {
    user = Provider.of<RiderProvider>(context, listen: false).rider;
    return SafeArea(
      child: Scaffold(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: UploadRiderProfile(_RiderProfileImage),
                ),
                SizedBox(
                  height: 23.h,
                ),
  ...
  Widget UploadRiderProfile(Uint8List? image) {
    return image == null
        ? Stack(
            children: [
              // RiderProfilePic(url: url, height: height, width: width)
